...
json.contact_tag_list resource.contact_tag_list.respond_to?(:to_a) ? resource.contact_tag_list.to_a : resource.contact_tag_list.to_s.split(',').map(&:strip).reject(&:blank?)
